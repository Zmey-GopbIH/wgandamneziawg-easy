...
module.exports.CERT_PATH = '/etc/wireguard/certs/server.crt'; // Фиксированный путь к сертификату
module.exports.KEY_PATH = '/etc/wireguard/certs/server.key'; // Фиксированный путь к ключу
/** This is only kept for migration purpose. DO NOT USE! */
module.exports.PASSWORD = process.env.PASSWORD;
module.exports.PASSWORD_HASH = process.env.PASSWORD_HASH;
/** This is only kept for migration purpose. DO NOT USE! */
module.exports.USERNAME = process.env.USERNAME;
module.exports.USERNAME_HASH = process.env.USERNAME_HASH;
...
iptables -A FORWARD -i wg0 -o ${module.exports.WG_DEVICE} -s ${module.exports.WG_DEFAULT_ADDRESS.replace('x', '0')}/24 -j ACCEPT;
iptables -A FORWARD -i ${module.exports.WG_DEVICE} -o wg0 -d ${module.exports.WG_DEFAULT_ADDRESS.replace('x', '0')}/24 -j ACCEPT;
...
iptables -D FORWARD -i wg0 -o ${module.exports.WG_DEVICE} -s ${module.exports.WG_DEFAULT_ADDRESS.replace('x', '0')}/24 -j ACCEPT;
iptables -D FORWARD -i ${module.exports.WG_DEVICE} -o wg0 -d ${module.exports.WG_DEFAULT_ADDRESS.replace('x', '0')}/24 -j ACCEPT;
